...
public class CameraFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        userFolderName = view.findViewById(R.id.userFolderName);
        fileName = view.findViewById(R.id.fileName);

        //RelativeLayout cameraContainer = view.findViewById(R.id.cameraContainer);
        //RectangleView mRectangleView = new RectangleView(getContext());
